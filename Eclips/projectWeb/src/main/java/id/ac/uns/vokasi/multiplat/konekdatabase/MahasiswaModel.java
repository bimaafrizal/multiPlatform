...
public class MahasiswaModel {
	...
	public MahasiswaModel() {
		...
		try {
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost/multiplat?user=root&password=");
	...
	public void insertMahasiswa(Mahasiswa mahasiswa) {
		String query = "INSERT INTO mahasiswa(id_ppdb, nim, nama, jk, tempat_lahir, tanggal_lahir, alamat) VALUES("
